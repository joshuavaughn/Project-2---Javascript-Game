...
function initialize(level) {
    ...
    let halflength = level / 2;

    document.querySelector(`#containerRow1`).innerHTML = ``;
    document.querySelector(`#containerRow2`).innerHTML = ``;

    for (let i = 0; i < halflength; i++) {
        document.querySelector(`#containerRow1`).innerHTML += `
        <div class="col d-flex justify-content-center">
            <div class="card" style="height: 20em; width: 15em; background-color: #818384;" id = "card${idCounter}">
                <div class="card-body d-flex justify-content-center align-items-center" style="">
                    <img src="./sources/images/question-mark.png" class="card-icon" alt="question-mark" id = "icon${idCounter}">
                </div>
            </div>
        </div>`;
        idCounter++;
